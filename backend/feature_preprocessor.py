...
class FeaturePreprocessor:
    ...
    def load(cls, file_path):
        ...
        try:
            ...
            error_result = handle_error(e, f"loading preprocessor from {file_path}")
    ...
    def save(self, file_path):
        ...
        try:
            ...
            error_result = handle_error(e, f"saving preprocessor to {file_path}")
            logger.error(f"Error saving preprocessor: {error_result['error']}")
            return False